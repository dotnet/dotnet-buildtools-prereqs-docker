...
internal static class Config
{
    ...
    public static string RepoDirectory => (string)AppContext.GetData(ConfigSwitchPrefix + nameof(RepoDirectory))! ?? 
        throw new InvalidOperationException("RepoDirectory must be specified");
